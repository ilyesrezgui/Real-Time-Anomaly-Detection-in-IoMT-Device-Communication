...
def feature_selection(X_train, features, base_path, corr_threshold=0.97):
    ...
    print(f"Features before selection: {len(features)}")  # ← Add here
    ...
    print(f"Features after variance threshold: {len(kept_after_vt)}")  # ← Add here
    ...
    print(f"Features after correlation filtering: {len(final_features)}")  # ← Add here
